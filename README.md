...
My journey with GenAI began in 2024, when I built a translation QA tool using an RPA tool (Power Automate) and Azure OpenAI—without any knowledge of the tool—which eventually led me to create similar tools in Python.
